...
export default function Navbar() {
  ...
  return (
    ...
    <div className="fixed top-0 left-0 w-screen h-screen invisible z-50">
      <nav className="visible fixed inset-x-5 top-5 backdrop-blur brightness-105 bg-gradient-to-br from-red-400/10 via-blue-400/10 to-cyan-400/10 border-white border-2 border-opacity-30 shadow-xl rounded-3xl z-50 px-10 py-3 10 flex flex-row content-center justify-between items-center">
        <Link href="/">
          <Image src="/logo.png" alt="" width={48} height={49} />
        </Link>
        <div className="visible duration-700 hidden md:flex flex-col md:flex-row backdrop-blur md:backdrop-blur-0 justify-center items-center gap-4 md:gap-2">
